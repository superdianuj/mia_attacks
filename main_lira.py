...
in_mean, in_std, out_mean, out_std = estimate_loss_distributions(target_img_coll, target_label_coll, shadow_imgs, shadow_labels,num_shadow_models=num_shadow_models, epochs=epochs_shadow_model, lr=lr_shadow_model)
mia_result = run_over_MIA(net, target_img_coll, target_label_coll, in_mean, in_std, out_mean, out_std)
